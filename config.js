...
var config = function () {
     ...
     */
    // *nux
    // this.ipcPath = process.env["HOME"] + "/.ethermint/geth.ipc";
    // windows
    // this.ipcPath = "\\\\.\\pipe\\geth.ipc";
    ...
    http uri
     */
    this.httpUri = "http://10.10.0.1:8545";

    this.provider = new web3.providers.HttpProvider(this.httpUri);
